...
-   And many more unexpected [errors]{style="color: red;"}!
:::
...
-   Studies[^1] have suggested that students learn more during debug session compared to error-free lecture.
:::
...
::: {.column width="50%"}
::: fragment
![](images/read_csv_error4.png) ![](images/syntax_error1.png) ![](images/read_csv_error1.png)
:::
:::
...
::: {.column width="30%"}
::: fragment
### [QUESTION]{style="color: red;"} `r emo::ji("no")`
:::
:::
...
`r fa_list(c("fa-brands fa-slideshare" = "https://danyangdai.github.io/LearnR_OZCOTS_2023_presentation/","fa-brands fa-github" = "https://github.com/DanyangDai/LearnR_OZCOTS_2023_presentation","fa-solid fa-globe" = "https://learnr.numbat.space","fa-solid fa-code-branch" = "Collaborate at: https://github.com/numbats/learnr"))`
